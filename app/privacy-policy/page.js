export default function page() {
  return (
    <main className="flex flex-col gap-8 min-h-[70vh] lg:min-h-[100vh] px-6 md:px-[50px] pt-32 md:pt-48 pb-8 ">
      <h1 className={`font-medium text-3xl md:text-7xl text-primary`}>
        Privacy Policy of KOJI Agency
      </h1>
      <div className="w-full flex flex-col gap-2 items-start">
        <p>Last Updated: 17/04/2024</p>
        <p>
          KOJI Agency operates the kojiagency.com website, which provides the
          SERVICE.
        </p>
        ...
        <p>
          ...
          anyone decided to use our Service, the KOJI Agency website.
        </p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at kojiagency.com, unless
          otherwise defined in this Privacy Policy.
        </p>

        <h2 className="font-medium text-lg">Information Collection and Use</h2>
        ...
        <h2 className="font-medium text-lg">Log Data</h2>
        ...
        <h2 className="font-medium text-lg">Service Providers</h2>
        ...
        <h2 className="font-medium text-lg">Links to Other Sites</h2>
        ...
        <p className="font-medium text-lg">Children's Privacy</p>
